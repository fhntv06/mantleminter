...
const RevokeModal = ({ isOpen, onClose, tokenSymbol = 'MAM', account, tokenAddress, setIsWalletModalOpen, setNotification, setTokenAddress, handleUpdateTokenInfo}) => {
  ...
  return (
    <div 
      className="fixed inset-0 bg-[#D9D9D9] bg-opacity-10 backdrop-blur-lg flex items-center justify-center z-[999] transition-opacity duration-600 ease-in-out"
      ...
      >
        ...
        <div className="flex justify-center gap-4">
          ...
          <button
            ...
            className="px-8 py-2 rounded-full bg-[#049CB6] text-white transition-colors"
