  ...
  return (
    <div className="relative mb-5.5" ref={addressInputRef}>
      ...
      {showAddressHistory && addressHistory.length > 0 && (
        <div className="absolute w-full bg-[#545454] rounded-2xl top-[calc(100%-15px)] z-[999] overflow-hidden">
          {addressHistory.map((address, index) => (
            <div
              key={index}
              className="flex items-center bg-white hover:bg-[#5A5A5A] hover:text-white px-4 py-2.5 cursor-pointer text-black text-[0.925rem] transition-colors"
