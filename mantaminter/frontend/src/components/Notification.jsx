...
const Notification = ({ notification, onClose }) => {
  ...
  return (
    <div 
      onClick={handleClose} 
      className={`fixed bg-[#0A1D27] bottom-8 left-8 text-white px-6 py-3 rounded-lg text-[0.925rem] z-[99999999] flex items-center gap-3 cursor-pointer transition-all duration-300 whitespace-nowrap ${
