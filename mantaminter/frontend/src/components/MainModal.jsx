...
const ModalOverlay = React.memo(({ children, onClose }) => (
  <div 
    className="modal fixed inset-0 bg-[#000000] bg-opacity-30 backdrop-blur-lg flex items-center justify-center z-[999] modal-overlay tokenModalMam"
    onClick={onClose}
  >
    {children}
  </div>
...
const ModalHeader = React.memo(({ onClose }) => (
  <>
    ...
    <h2 className="modalTokenHeaderAdap text-xl sm:text-3xl text-center text-white font-extralight px-5 sm:px-10">
      $MAM are tokens of the manta minter project, which in the future you will be able to mint on your wallet or spend on promotion in manta memepad.
    </h2>
