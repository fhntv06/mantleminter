  ...
  return (
      <div className="min-h-screen flex flex-col bg-[#040404]">
        <div className="background-element">
          <div className="background-element-mask"/>
          <img className="background-element-img" src='bg-animate/bg.png' />
        </div>
        ...
        <main className="flex-grow z-10 mb-32">
          <div className="max-w-[1210px] mx-auto px-4 sm:px-5.5">
            ...
            <div className='flex flex-col max-w-[350px] mb-11'>
              <h1 className="text-2xl sm:text-4xl mt-6 sm:mt-10 font-semibold text-black">Mint your token</h1>
            </div>
