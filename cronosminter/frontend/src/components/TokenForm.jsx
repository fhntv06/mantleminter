    ...
    return (
      <>
        ...
        <BurnModal
          ...
          handleUpdateTokenInfo={handleUpdateTokenInfo}
        />
      <div className="border border-[#D9D9D9] rounded-3xl p-5.5">
        ...
        <div className="space-y-6">
          <div>
            ...
            <div className="relative">
              <input
                ...
                value={tokenAddress}
                readOnly
                className="w-full placeholder-white border bg-[transparent] border-[#C7C6C6] rounded-full py-2.75 px-4 text-lg pr-12"
              />
              <button
                onClick={(e) => {
                  e.stopPropagation();
            ...
            <p className="text-[#C1C1C1] text-xs mt-1 ml-4">On-chain smart contract address of the token parent.</p>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                readOnly
                className="w-full placeholder-white border bg-[transparent] border-[#C7C6C6] rounded-full py-2.75 px-4 text-lg"
              />
              {isOwner && (
              <button
                className="absolute right-1 top-1/2 transform -translate-y-1/2 text-[#C1C1C1] h-[36px] w-[124px] rounded-full text-sm"
                onClick={(e) => {
                  e.stopPropagation();
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                readOnly
                className="w-full placeholder-white border bg-[transparent] border-[#C7C6C6] rounded-full py-2.75 pl-4 pr-[80px] text-lg"
              />
              {isOwner && (
              <button
                className="absolute right-1 top-1/2 transform -translate-y-1/2 text-[#C1C1C1] h-[36px] w-[70px] rounded-full text-sm"
                onClick={(e) => {
                  e.stopPropagation();
          ...
          <div>
            ...
            <p className="text-[#C1C1C1] text-xs mt-1 ml-4">
          ...
          <div className="flex justify-center mt-4">
            <button
              ...
              className="border border-[#fff] hover:bg-[#545454] text-white px-6 py-2 rounded-full text-[18px] transition-colors"
            >
              Add token to wallet
            </button>
          </div>
        ...
        <div>
          <div>
            <input
              ...
              className="w-full placeholder-white border bg-[transparent] border-[#C7C6C6] rounded-full py-2.75 px-4 text-lg"
            />
            <p className="text-[0.725rem] text-[#C1C1C1] mt-1.75 ml-4">
              Your project unabbreviated name with spaces (usually 1-3 words).{' '}
              <button onClick={() => setTokenName('CronosMinter')} className="font-bold hover:text-white">
                Use example
              </button>
            </p>
          </div>
          ...
          <div className="mt-5">
            ...
            <p className="text-[0.725rem] text-[#C1C1C1] mt-1.75 ml-4">
              ...
              <button onClick={() => setTokenSymbol('COM')} className="font-bold hover:text-white">
                Use example
              </button>
            </p>
          </div>
          <input
            className="w-full placeholder-white bg-[transparent] border border-[#C7C6C6] rounded-full py-2.75 px-4 text-lg mt-5"
            placeholder="Decimal"
            type="number"
            max="18"
            min="0"
          ...
          />
          <p className="text-[0.725rem] text-[#C1C1C1] ml-4">
            The decimal precision of your token (18 is Cronos default).{' '}
          ...
          <input
            ...
            className="w-full border placeholder-white bg-[transparent] border-[#C7C6C6] rounded-full py-2.75 px-4 text-lg"
          />
          ...
          <div className="flex justify-center mt-8">
            <button
              ...
              disabled={loading}
              className="ripple-button text-white px-4 sm:px-6 py-2 rounded-full flex items-center justify-center border hover:bg-[#545454] min-w-40 border-white gap-2 sm:gap-3 text-[0.825rem] sm:text-[18px] transition-all duration-200"
              onMouseDown={(e) => {
